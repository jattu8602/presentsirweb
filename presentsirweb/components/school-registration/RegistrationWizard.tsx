...
export function RegistrationWizard() {
          ...
          try {
            ...
            if (!registrationResponse.ok) {
              toast({
                title: 'Registration Error',
                description:
                  registrationData.message || 'Failed to complete registration',
                variant: 'destructive',
              })
              setIsSubmitting(false)
              return
            ...
            // Set success state and password
  ...
  // If registration is complete, show the completion page
  if (isSuccess && password) {
    return <RegistrationComplete password={password} />
  }
